...
try:
    ...
    import LncLOOMv2.LincRNA_Blast as LB
    import LncLOOMv2.LincRNA_Annotate as LA
    import LncLOOMv2.LincRNA_Output as LO
    import LncLOOMv2.LincStats as LS
except:
...
def get_options():
   ...
   #Add parameters associated with annotation - default is to not annotate
    ...
    parser.add_argument("-eclip", "--eclip", dest="eclip",help="Annotates with eCLIP data, according to paths specified in src/for_eclip_annotation.txt", action="store_true")
    ...
    if Valid:
        ...
        if track ==True:
            ...
            try:
                ...
                print("Format of LncLOOMv2/src/for_track_output.txt incorrect. Track output not generated")
                format_file = False
        ...
        if select!='DEEPEST': 
           ...
           level_keys = list(Motif_Graph_Levels.keys())
           if level_keys:
